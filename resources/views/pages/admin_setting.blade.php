            ...
            <ul class="nav nav-tabs nav-line-tabs nav-line-tabs-2x border-transparent fs-4 fw-semibold mb-15"
                ...
                <li class="nav-item" role="presentation" class="active">
                    <a class="nav-link text-active-primary pb-5" data-bs-toggle="tab" href="#kt_jobs"
                        ...
                        <!--end::Svg Icon--> اعدادات خاصة بالادارة    
                    </a>
                </li>
            </ul>
            <!--end:::Tabs-->
...
<form method="post" action="{{ route('general_info.store') }}" enctype="multipart/form-data">
    ...
    <div class="row">
        ...
        <div class="form-group col-md-6">
            ...
            <input type="number" class="form-control" value="{{ get_general_value('admin_service') }}" name="general[admin_service]" id="">

        </div>
        <div class="form-group col-md-6">

            <br><label>   نسبة الادارة من كل استشارة؟     :</label>
            <input type="number" class="form-control" value="{{ get_general_value('admin_consultion') }}" name="general[admin_consultion]" id="">
