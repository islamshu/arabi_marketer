...
<form method="post" action="{{ route('store_test') }}" enctype="multipart/form-data">
    ...
    <div class="row">
        ...
        <div class="form-group col-md-6">
            ...
            <input type="text" class="percent" value="{{ get_general_value('admin_service') }}%" name="general[admin_service]" id="">

        </div>
        <div class="form-group col-md-6">

            <br><label>   نسبة الادارة من كل استشارة؟     :</label>
            <input type="text" class=" percent" value="{{ get_general_value('admin_consultion') }}%" name="general[admin_consultion]" id="">
