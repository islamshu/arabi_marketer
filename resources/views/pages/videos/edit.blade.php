            ...
            <form method="post" action="{{ route('videos.update',$video->id) }}" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" id="title_ar" value="{{ $video->title }}" name="title" required class="form-control form-control-solid"
                            placeholder="العنوان " />
            
                    </div>
                    <div class=" col-md-6">
                        <div class="form-group">
                            <br> <label data-error="wrong" data-success="right" for="form3"> صورة  (800*470)  <span
                    ...
                    <div class="form-group col-md-8">
                        ...
                        <textarea name="description" class="form-control form-control-solid" >{{ $video->description }}</textarea>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <br> <label>رابط الفيديو :</label>
                        <input class="form-control form-control-sm form-control-solid " value="{{ $video->url }}" required name="url"
                            placeholder="الرابط" id="" />
                    ...
                    {{-- <div class="form-group col-md-6">
                        ...
                        <select name="type_video" class="form-control"  required id="type_file">
                            ...
                            <option value="file" @if($video->type == 'file' )selected @endif>ملف</option>
                            <option value="url"  @if($video->url == 'file' )selected @endif>رابط</option>
