        ...
        <div class="card-body">
            ...
            <ul class="nav nav-tabs nav-line-tabs nav-line-tabs-2x border-transparent fs-4 fw-semibold mb-15"
                ...
                <li class="nav-item" role="presentation">
                    <a class="nav-link text-active-primary pb-5 active">
                        ...
                        <!--end::Svg Icon-->الكلمات المفتاحية للفيديوهات
                    </a>
            ...
            <div class="tab-content" id="myTabContent">
                ...
                <div class="tab-pane fade active show" id="kt_ecommerce_settings_general" role="tabpanel">
                    ...
                    <!--begin::Form-->
                    @include('pages.keyword_video._index')
                    <!--end::Form-->
                </div>
...
@section('scripts')
    ...
    <script type="text/javascript">
        ...
        $('#sendmemessage').on('submit', function(e) {
            ...
            store("{{ route('store_video_keyword') }}", 'post', data, '#kt_datatable_example_2', 'sendmemessage',
