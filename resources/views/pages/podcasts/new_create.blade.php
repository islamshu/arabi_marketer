    ...
    <div class="card card-flush">
        ...
        <div class="card-body">
            ...
            <ul class="nav nav-tabs nav-line-tabs nav-line-tabs-2x mb-5 fs-6">
                <li class="nav-item">
                    <a class="nav-link " href="{{ route('new_index') }}">بودكاست</a>
                </li>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 bg-light-info px-6 py-8 rounded-2 mb-7 mr-7 ml-7">
                                ...
                                <span class="svg-icon svg-icon-3x text-center svg-icon-danger d-block my-2">
                                    ...
                                    <img src="https://cdn-icons-png.flaticon.com/512/124/124033.png" height="80"
                                        alt="">
                                </span>
                                <!--end::Svg Icon-->
                            ...
                            <div class="col-md-6 bg-light-warning px-6 py-8 rounded-2 mb-7 mr-7 ml-7">
                                ...
                                <span class="svg-icon svg-icon-3x text-center svg-icon-danger d-block my-2">
                                    {{-- <i class="fa fa-user fa-4x"></i> --}}
                                    <img src="https://www.pngitem.com/pimgs/m/97-972731_podcast-podcasting-icon-hd-png-download.png"
                                        height="80" alt="">
                                </span>
                                <!--end::Svg Icon-->
                                <a href="{{ route('create_manula_podcast') }}" style="font-weight: bold;"
                                                ...
                                                <div class="form-group col-md-6">
                                                    <form method="post" action="{{ route('store_podcast') }}">
                                                        ...
                                                        <select class="form-select" required name="user_id"
                                                            ...
                                                            <option value="" selected disabled>يرجى الاختيار
                                                            </option>
...
@section('scripts')
    ...
    <script>
        $('#send_form').on('submit', function(e) {
            ...
            storefile("{{ route('podcasts.store') }}", 'post', formData, '#kt_datatable_example_2', 'sendmemessage',
