        ...
        <div class="card-body">
            ...
            <ul class="nav nav-tabs nav-line-tabs nav-line-tabs-2x border-transparent fs-4 fw-semibold mb-15"
                ...
                <li class="nav-item" role="presentation">
                    <a class="nav-link text-active-primary pb-5 active">
                        ...
                        <!--end::Svg Icon-->تصنيفات البودكاست
                    </a>
            ...
            <div class="tab-content" id="myTabContent">
                ...
                <div class="col-md-8" id="form_toshow" style="display: none;margin-top:5px">
                    <form action="{{ route('store_podcast_category') }}" method="post">
                        @csrf
...
@section('scripts')
    ...
    <script type="text/javascript">
        ...
        $('#sendmemessage').on('submit', function(e) {
            ...
            store("{{ route('store_podcast_category') }}", 'post', data, '#kt_datatable_example_4', 'sendmemessage',
