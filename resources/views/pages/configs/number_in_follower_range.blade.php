                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            <label>{{ __('القيمة الاولى') }}:</label>
                            <input type="text" name="general[first_follow_range]" class="form-control" placeholder="1000-5000" value="{{ get_general_value('first_follow_range') }}" id="">
                        </div>
                        <div class="form-group col-md-6">
                            <label>{{ __('القيمة الثانية ') }}:</label>
                            <input type="text" name="general[secand_follow_range]" class="form-control" placeholder="5000-10000" value="{{ get_general_value('secand_follow_range') }}" id="">
                        </div>
                        <div class="form-group col-md-6">
                            <label>{{ __('القيمة الثالثة') }}:</label>
                            <input type="text" name="general[third_follow_range]" class="form-control" placeholder="10000-20000" value="{{ get_general_value('third_follow_range') }}" id="">
                        </div>
                        <div class="form-group col-md-6">
                            <label>{{ __('القيمة الرابعة ') }}:</label>
                            <input type="text" name="general[fourth_follow_range]" class="form-control" placeholder="20000-اكثر" value="{{ get_general_value('fourth_follow_range') }}" id="">
                        </div>
