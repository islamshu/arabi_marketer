                    ...
                    <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                        ...
                        <div class="d-flex my-4">
                            <a href="#" class="btn btn-sm btn-light me-2" id="kt_user_follow_button">
                                ...
                                <span class="svg-icon svg-icon-3 d-none"><svg xmlns="http://www.w3.org/2000/svg"
                                        width="24" height="24" viewBox="0 0 24 24" fill="none">
                                        <path opacity="0.3"
                            ...
                            <a href="#" class="btn btn-sm btn-primary me-3" data-bs-toggle="tooltip"
                                data-bs-placement="left" data-bs-trigger="hover" data-kt-initialized="1">Hire Me</a>
                            ...
                            <div class="me-0">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-bold w-200px py-3"
                                    ...
                                    <div class="menu-item px-3" data-bs-toggle="tooltip" data-bs-placement="left"
                                        data-bs-trigger="hover" data-kt-initialized="1">
                                    ...
                                    <div class="menu-item px-3" data-kt-menu-trigger="hover"
                                        data-kt-menu-placement="left-start" data-bs-toggle="tooltip"
                                        data-bs-placement="left" data-bs-trigger="hover" data-kt-initialized="1">
                                        <a href="#" class="menu-link px-3">
                                    ...
                                    <div class="menu-item px-3 my-1">
                                        <a href="https://dashboard.arabicreators.com/account/settings"
                            ...
                            <div class="d-flex flex-wrap">
                                ...
                                <div
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <span class="svg-icon svg-icon-3 svg-icon-danger me-2"><svg
                                                xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none">
