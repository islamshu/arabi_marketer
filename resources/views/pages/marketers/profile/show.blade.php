...
<x-base-layout>
            ...
            <div class="d-flex flex-wrap flex-sm-nowrap mb-3">
                ...
                <div class="me-7 mb-4">
                    <div class="symbol symbol-100px symbol-lg-160px symbol-fixed position-relative">
                        <img src="https://dashboard.arabicreators.com/demo1/media/avatars/blank.png" alt="image">
                    ...
                    <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <div class="d-flex align-items-center mb-2">
                                <a href="#" class="text-gray-800 text-hover-primary fs-2 fw-bolder me-1">islam</a>
                                <a href="#">
    ...
    <span class="svg-icon svg-icon-4 me-1"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
    ...
    <!--end::Indicator-->
                            ...
                            <a href="#" class="btn btn-sm btn-primary me-3" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-trigger="hover" data-kt-initialized="1">Hire Me</a>
    ...
    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-bold w-200px py-3" data-kt-menu="true">
        ...
        <!--begin::Menu item-->
        <div class="menu-item px-3" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-trigger="hover" data-kt-initialized="1">
        ...
        <!--begin::Menu item-->
        <div class="menu-item px-3" data-kt-menu-trigger="hover" data-kt-menu-placement="left-start" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-trigger="hover" data-kt-initialized="1">
            <a href="#" class="menu-link px-3">
        ...
        <div class="menu-item px-3 my-1">
            <a href="https://dashboard.arabicreators.com/account/settings" class="menu-link px-3">
                Settings
            </a>
        </div>
        <!--end::Menu item-->
    ...
    <!--end::Svg Icon-->
            ...
            <div class="d-flex overflow-auto h-55px">
                <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bolder flex-nowrap">
                                    <!--begin::Nav item-->
                        <li class="nav-item">
                            <a class="nav-link text-active-primary me-6 " href="https://dashboard.arabicreators.com/account/overview">
                                Overview
                            </a>
                        </li>
                        <!--end::Nav item-->
                                    <!--begin::Nav item-->
                        <li class="nav-item">
                            <a class="nav-link text-active-primary me-6 active" href="https://dashboard.arabicreators.com/account/settings">
                                Settings
                            </a>
                        </li>
                        <!--end::Nav item-->
