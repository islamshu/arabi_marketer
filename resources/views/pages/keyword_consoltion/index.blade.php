        ...
        <div class="card-body">
            ...
            <ul class="nav nav-tabs nav-line-tabs nav-line-tabs-2x border-transparent fs-4 fw-semibold mb-15"
                ...
                <li class="nav-item" role="presentation">
                    <a class="nav-link text-active-primary pb-5 active">
                        ...
                        <!--end::Svg Icon-->الكلمات المفتاحية للاستشارات
                    </a>
            ...
            <div class="tab-content" id="myTabContent">
                ...
                <div class="tab-pane fade active show" id="kt_ecommerce_settings_general" role="tabpanel">
                    ...
                    <!--begin::Form-->
                    @include('pages.keyword_consoltion._index')
                    <!--end::Form-->
                </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h4 class="modal-title"> اضف كلمات مفتاحية </h4>
...
@section('scripts')
    ...
    <script type="text/javascript">
        ...
        $('#sendmemessage').on('submit', function(e) {
            ...
            store("{{ route('store_consoltion_keyword') }}",'post', data,'#kt_datatable_example_2','sendmemessage','#exampleModal','Added successfully');
