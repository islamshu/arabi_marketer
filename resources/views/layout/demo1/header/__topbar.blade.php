...
<div class="d-flex align-items-stretch flex-shrink-0">
    ...
    <div class="d-flex align-items-center {{ $itemClass }}">
        ...
        <!--begin::Menu toggle-->
        <!--begin::Menu-->
        <div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px show" data-kt-menu="true" data-popper-placement="bottom-end" style="z-index: 105; position: fixed; inset: 0px 0px auto auto; margin: 0px; transform: translate3d(-137.6px, 55.2px, 0px);">
            <!--begin::Heading-->
            <div class="d-flex flex-column bgi-no-repeat rounded-top" style="background-image:url('https://dashboard.digitalgo.net/demo1/media/misc/pattern-1.jpg')">
                <!--begin::Title-->
        ...
        <span class="svg-icon svg-icon-2 svg-icon-Direct"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
        ...
        <rect x="11" y="17" width="2" height="2" rx="1" transform="rotate(-90 11 17)" fill="currentColor"></rect>
                            ...
                            <!--begin::Title-->
                            <div class="mb-0 me-2">
                                <a href="#" class="fs-6 text-gray-800 text-hover-primary fw-bolder">رسالة جديدة</a>
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="symbol symbol-35px me-4">
                                <span class="symbol-label bg-light-General">
                                    <!--begin::Svg Icon | path: assets/media/icons/duotune/general/gen044.svg-->
        <span class="svg-icon svg-icon-2 svg-icon-General"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
        <rect opacity="0.3" x="2" y="2" width="20" height="20" rx="10" fill="currentColor"></rect>
        <rect x="11" y="14" width="7" height="2" rx="1" transform="rotate(-90 11 14)" fill="currentColor"></rect>
        <rect x="11" y="17" width="2" height="2" rx="1" transform="rotate(-90 11 17)" fill="currentColor"></rect>
        </svg></span>
                ...
                <div class="py-3 text-center border-top">
                    <a href="https://dashboard.digitalgo.net/pages/profile/activity" class="btn btn-color-gray-600 btn-active-color-primary">
                        View All
