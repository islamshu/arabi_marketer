...
<div class="d-flex align-items-stretch flex-shrink-0">
    ...
    <div class="d-flex align-items-center {{ $itemClass }}">
        ...
        <div style=" position: absolute;margin-top: 27%;width: 20%;background: #fff;z-index: 5;max-height: 300px;text-align:left" class="menu menu-sub menu-sub-dropdown menu-column menu-rounded ">
            <!--begin::Menu item-->
